...
the \tname{LeechBasis} of $\Leech(-1)$.
Hence \tname{GramL26}  is the block diagonal matrix with diagonal entries 
{\small $\left[\begin{array}{cc} 0 &1 \\ 1 & 0\end{array}\right]$\mystruthd{23pt}{18pt}}
 and  \tname{GramLeech}.
In the following,
